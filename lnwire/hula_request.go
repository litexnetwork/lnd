...
// Decode deserializes a serialized HULARequest stored in the passed
// io.Reader observing the specified protocol version.
//
// This is part of the lnwire.Message interface.
func (req *HULARequest) Decode(r io.Reader, pver uint32) error {
...
//
func (req *HULARequest) Encode(w io.Writer, pver uint32) error {
...
//
// This is part of the lnwire.Message interface.
func (a *HULARequest) MsgType() MessageType {
...
//
// This is part of the lnwire.Message interface.
func (a *HULARequest) MaxPayloadLength(pver uint32) uint32 {
	return 65533
}
