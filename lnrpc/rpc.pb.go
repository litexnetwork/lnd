...
const (
	Invoice_NORMAL_INVOICE      Invoice_InvoiceType = 0
	Invoice_CROSS_CHAIN_INVOICE Invoice_InvoiceType = 1
)

var Invoice_InvoiceType_name = map[int32]string{
	0: "NORMAL_INVOICE",
	1: "CROSS_CHAIN_INVOICE",
}
var Invoice_InvoiceType_value = map[string]int32{
	"NORMAL_INVOICE":      0,
	"CROSS_CHAIN_INVOICE": 1,
}

func (x Invoice_InvoiceType) String() string {
	return proto.EnumName(Invoice_InvoiceType_name, int32(x))
}
func (Invoice_InvoiceType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{83, 0} }
...
type SendResponseWithHash struct {
	RHash           []byte `protobuf:"bytes,1,opt,name=r_hash,proto3" json:"r_hash,omitempty"`
	PaymentError    string `protobuf:"bytes,2,opt,name=payment_error" json:"payment_error,omitempty"`
	PaymentPreimage []byte `protobuf:"bytes,3,opt,name=payment_preimage,proto3" json:"payment_preimage,omitempty"`
	PaymentRoute    *Route `protobuf:"bytes,4,opt,name=payment_route" json:"payment_route,omitempty"`
}

func (m *SendResponseWithHash) Reset()                    { *m = SendResponseWithHash{} }
func (m *SendResponseWithHash) String() string            { return proto.CompactTextString(m) }
func (*SendResponseWithHash) ProtoMessage()               {}
func (*SendResponseWithHash) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }

func (m *SendResponseWithHash) GetRHash() []byte {
	if m != nil {
		return m.RHash
	}
	return nil
...
func (m *SendResponseWithHash) GetPaymentError() string {
	if m != nil {
		return m.PaymentError
	}
	return ""
...
func (m *SendResponseWithHash) GetPaymentPreimage() []byte {
	if m != nil {
		return m.PaymentPreimage
	}
	return nil
...
func (m *SendResponseWithHash) GetPaymentRoute() *Route {
	if m != nil {
		return m.PaymentRoute
	}
	return nil
...
type SendMultiRequest struct {
	Amt     int64             `protobuf:"varint,1,opt,name=amt" json:"amt,omitempty"`
	Address *LightningAddress `protobuf:"bytes,2,opt,name=address" json:"address,omitempty"`
	PathNum int32             `protobuf:"varint,3,opt,name=path_num" json:"path_num,omitempty"`
}

func (m *SendMultiRequest) Reset()                    { *m = SendMultiRequest{} }
func (m *SendMultiRequest) String() string            { return proto.CompactTextString(m) }
func (*SendMultiRequest) ProtoMessage()               {}
func (*SendMultiRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }

func (m *SendMultiRequest) GetAmt() int64 {
	if m != nil {
		return m.Amt
	}
	return 0
...
func (m *SendMultiRequest) GetAddress() *LightningAddress {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *SendMultiRequest) GetPathNum() int32 {
	if m != nil {
		return m.PathNum
	}
	return 0
...
type SendMultiResponse struct {
	PaymentResponse []*SendResponseWithHash `protobuf:"bytes,1,rep,name=payment_response" json:"payment_response,omitempty"`
	PaymentError    string                  `protobuf:"bytes,2,opt,name=payment_error" json:"payment_error,omitempty"`
}

func (m *SendMultiResponse) Reset()                    { *m = SendMultiResponse{} }
func (m *SendMultiResponse) String() string            { return proto.CompactTextString(m) }
func (*SendMultiResponse) ProtoMessage()               {}
func (*SendMultiResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }

func (m *SendMultiResponse) GetPaymentResponse() []*SendResponseWithHash {
	if m != nil {
...
func (m *SendMultiResponse) GetPaymentError() string {
	if m != nil {
		return m.PaymentError
	}
	return ""
...
type RebalanceStatusUpdate struct {
	// Types that are valid to be assigned to Update:
	//	*RebalanceStatusUpdate_ChanPending
	//	*RebalanceStatusUpdate_Confirmation
	//	*RebalanceStatusUpdate_ChanResume
	Update isRebalanceStatusUpdate_Update `protobuf_oneof:"update"`
}

func (m *RebalanceStatusUpdate) Reset()                    { *m = RebalanceStatusUpdate{} }
func (m *RebalanceStatusUpdate) String() string            { return proto.CompactTextString(m) }
func (*RebalanceStatusUpdate) ProtoMessage()               {}
func (*RebalanceStatusUpdate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{48} }

type isRebalanceStatusUpdate_Update interface{ isRebalanceStatusUpdate_Update() }

type RebalanceStatusUpdate_ChanPending struct {
	ChanPending *PendingUpdate `protobuf:"bytes,1,opt,name=chan_pending,oneof"`
}
type RebalanceStatusUpdate_Confirmation struct {
	Confirmation *ConfirmationUpdate `protobuf:"bytes,2,opt,name=confirmation,oneof"`
}
type RebalanceStatusUpdate_ChanResume struct {
	ChanResume *ChannelOpenUpdate `protobuf:"bytes,3,opt,name=chan_resume,oneof"`
}

func (*RebalanceStatusUpdate_ChanPending) isRebalanceStatusUpdate_Update()  {}
func (*RebalanceStatusUpdate_Confirmation) isRebalanceStatusUpdate_Update() {}
func (*RebalanceStatusUpdate_ChanResume) isRebalanceStatusUpdate_Update()   {}

func (m *RebalanceStatusUpdate) GetUpdate() isRebalanceStatusUpdate_Update {
	if m != nil {
		return m.Update
	}
	return nil
...
func (m *RebalanceStatusUpdate) GetChanPending() *PendingUpdate {
	if x, ok := m.GetUpdate().(*RebalanceStatusUpdate_ChanPending); ok {
		return x.ChanPending
	}
	return nil
}

func (m *RebalanceStatusUpdate) GetConfirmation() *ConfirmationUpdate {
	if x, ok := m.GetUpdate().(*RebalanceStatusUpdate_Confirmation); ok {
		return x.Confirmation
	}
	return nil
}

func (m *RebalanceStatusUpdate) GetChanResume() *ChannelOpenUpdate {
	if x, ok := m.GetUpdate().(*RebalanceStatusUpdate_ChanResume); ok {
		return x.ChanResume
	}
	return nil
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*RebalanceStatusUpdate) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _RebalanceStatusUpdate_OneofMarshaler, _RebalanceStatusUpdate_OneofUnmarshaler, _RebalanceStatusUpdate_OneofSizer, []interface{}{
		(*RebalanceStatusUpdate_ChanPending)(nil),
		(*RebalanceStatusUpdate_Confirmation)(nil),
		(*RebalanceStatusUpdate_ChanResume)(nil),
	}
}

func _RebalanceStatusUpdate_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*RebalanceStatusUpdate)
	// update
	switch x := m.Update.(type) {
	case *RebalanceStatusUpdate_ChanPending:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ChanPending); err != nil {
			return err
		}
	case *RebalanceStatusUpdate_Confirmation:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Confirmation); err != nil {
			return err
		}
	case *RebalanceStatusUpdate_ChanResume:
		b.EncodeVarint(3<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ChanResume); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("RebalanceStatusUpdate.Update has unexpected type %T", x)
	}
	return nil
}

func _RebalanceStatusUpdate_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*RebalanceStatusUpdate)
	switch tag {
	case 1: // update.chan_pending
		if wire != proto.WireBytes {
		...
		msg := new(PendingUpdate)
		err := b.DecodeMessage(msg)
		m.Update = &RebalanceStatusUpdate_ChanPending{msg}
		return true, err
	case 2: // update.confirmation
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		msg := new(ConfirmationUpdate)
		err := b.DecodeMessage(msg)
		m.Update = &RebalanceStatusUpdate_Confirmation{msg}
		return true, err
	case 3: // update.chan_resume
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ChannelOpenUpdate)
		err := b.DecodeMessage(msg)
		m.Update = &RebalanceStatusUpdate_ChanResume{msg}
		return true, err
	default:
		return false, nil
	}
...
func _RebalanceStatusUpdate_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*RebalanceStatusUpdate)
	// update
	switch x := m.Update.(type) {
	case *RebalanceStatusUpdate_ChanPending:
...
type AddFundRequest struct {
	// / channel id of which channel we want add fund to.
	ChannelPoint *ChannelPoint `protobuf:"bytes,1,opt,name=channel_point,json=channelPoint" json:"channel_point,omitempty"`
	// / The value we want to add.
	AddFundingAmount int64 `protobuf:"varint,2,opt,name=add_funding_amount,json=addFundingAmount" json:"add_funding_amount,omitempty"`
	// / The target number of blocks that the closure transaction should be confirmed by.
	TargetConf int32 `protobuf:"varint,3,opt,name=target_conf,json=targetConf" json:"target_conf,omitempty"`
	// / A manual fee rate set in sat/byte that should be used when crafting the closure transaction.
	SatPerByte int64 `protobuf:"varint,4,opt,name=sat_per_byte,json=satPerByte" json:"sat_per_byte,omitempty"`
...
func (*AddFundRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{49} }

func (m *AddFundRequest) GetChannelPoint() *ChannelPoint {
	if m != nil {
		return m.ChannelPoint
	}
	return nil
...
func (m *AddFundRequest) GetAddFundingAmount() int64 {
	if m != nil {
		return m.AddFundingAmount
	}
	return 0
}

func (m *AddFundRequest) GetTargetConf() int32 {
	if m != nil {
		return m.TargetConf
	}
	return 0
...
func (m *AddFundRequest) GetSatPerByte() int64 {
	if m != nil {
		return m.SatPerByte
	}
	return 0
...
type ExtractFundRequest struct {
	// / channel id of which channel we want extract fund from.
	ChannelPoint *ChannelPoint `protobuf:"bytes,1,opt,name=channel_point,json=channelPoint" json:"channel_point,omitempty"`
	// / The value we want to extract.
	ExtractFundingAmount int64 `protobuf:"varint,2,opt,name=extract_funding_amount,json=extractFundingAmount" json:"extract_funding_amount,omitempty"`
	// / A manual fee rate set in sat/byte that should be used when crafting the closure transaction.
	SatPerByte int64 `protobuf:"varint,3,opt,name=sat_per_byte,json=satPerByte" json:"sat_per_byte,omitempty"`
}

func (m *ExtractFundRequest) Reset()                    { *m = ExtractFundRequest{} }
func (m *ExtractFundRequest) String() string            { return proto.CompactTextString(m) }
func (*ExtractFundRequest) ProtoMessage()               {}
func (*ExtractFundRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{50} }

func (m *ExtractFundRequest) GetChannelPoint() *ChannelPoint {
	if m != nil {
		return m.ChannelPoint
	}
	return nil
...
func (m *ExtractFundRequest) GetExtractFundingAmount() int64 {
	if m != nil {
		return m.ExtractFundingAmount
	}
	return 0
}

func (m *ExtractFundRequest) GetSatPerByte() int64 {
	if m != nil {
		return m.SatPerByte
	}
	return 0
...
type AddFundResponse struct {
	// / If add funding was success.
	Success bool `protobuf:"varint,1,opt,name=success" json:"success,omitempty"`
}

func (m *AddFundResponse) Reset()                    { *m = AddFundResponse{} }
func (m *AddFundResponse) String() string            { return proto.CompactTextString(m) }
func (*AddFundResponse) ProtoMessage()               {}
func (*AddFundResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{51} }

func (m *AddFundResponse) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
type Invoice struct {
	...
	// / The address type
	Type Invoice_InvoiceType `protobuf:"varint,16,opt,name=type,enum=lnrpc.Invoice_InvoiceType" json:"type,omitempty"`
}
...
func (m *Invoice) GetType() Invoice_InvoiceType {
	if m != nil {
		return m.Type
	}
	return Invoice_NORMAL_INVOICE
}
...
func init() {
	...
	proto.RegisterType((*SendResponseWithHash)(nil), "lnrpc.SendResponseWithHash")
	proto.RegisterType((*SendMultiRequest)(nil), "lnrpc.SendMultiRequest")
	proto.RegisterType((*SendMultiResponse)(nil), "lnrpc.SendMultiResponse")
	...
	proto.RegisterType((*RebalanceStatusUpdate)(nil), "lnrpc.RebalanceStatusUpdate")
	proto.RegisterType((*AddFundRequest)(nil), "lnrpc.AddFundRequest")
	proto.RegisterType((*ExtractFundRequest)(nil), "lnrpc.ExtractFundRequest")
	proto.RegisterType((*AddFundResponse)(nil), "lnrpc.AddFundResponse")
	...
	proto.RegisterEnum("lnrpc.Invoice_InvoiceType", Invoice_InvoiceType_name, Invoice_InvoiceType_value)
}
...
type LightningClient interface {
	...
	// * lncli: `sendmanypayments`
	// 一次性发送多个payments，双向的rpc
	SendMultiPaymentsSync(ctx context.Context, in *SendMultiRequest, opts ...grpc.CallOption) (*SendMultiResponse, error)
	// TODO(xuehan): change AddFundResponse to a stream statusUpdate.
	// rpc AddFund (AddFundRequest) returns (AddFundResponse);
	AddFund(ctx context.Context, in *AddFundRequest, opts ...grpc.CallOption) (Lightning_AddFundClient, error)
	// * lncli： `extractfund`
	// ExtractFund attempts to extract some fund from an existring channel.
	ExtractFund(ctx context.Context, in *ExtractFundRequest, opts ...grpc.CallOption) (Lightning_ExtractFundClient, error)
	// *
...
func (c *lightningClient) SendMultiPaymentsSync(ctx context.Context, in *SendMultiRequest, opts ...grpc.CallOption) (*SendMultiResponse, error) {
	out := new(SendMultiResponse)
	err := grpc.Invoke(ctx, "/lnrpc.Lightning/SendMultiPaymentsSync", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lightningClient) AddFund(ctx context.Context, in *AddFundRequest, opts ...grpc.CallOption) (Lightning_AddFundClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Lightning_serviceDesc.Streams[4], c.cc, "/lnrpc.Lightning/AddFund", opts...)
	if err != nil {
		return nil, err
	}
	x := &lightningAddFundClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Lightning_AddFundClient interface {
	Recv() (*OpenStatusUpdate, error)
	grpc.ClientStream
}

type lightningAddFundClient struct {
	grpc.ClientStream
}

func (x *lightningAddFundClient) Recv() (*OpenStatusUpdate, error) {
	m := new(OpenStatusUpdate)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *lightningClient) ExtractFund(ctx context.Context, in *ExtractFundRequest, opts ...grpc.CallOption) (Lightning_ExtractFundClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Lightning_serviceDesc.Streams[5], c.cc, "/lnrpc.Lightning/ExtractFund", opts...)
	if err != nil {
		return nil, err
	}
	x := &lightningExtractFundClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Lightning_ExtractFundClient interface {
	Recv() (*OpenStatusUpdate, error)
	grpc.ClientStream
}

type lightningExtractFundClient struct {
	grpc.ClientStream
}

func (x *lightningExtractFundClient) Recv() (*OpenStatusUpdate, error) {
	m := new(OpenStatusUpdate)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type LightningServer interface {
	...
	// * lncli: `sendmanypayments`
	// 一次性发送多个payments，双向的rpc
	SendMultiPaymentsSync(context.Context, *SendMultiRequest) (*SendMultiResponse, error)
	// TODO(xuehan): change AddFundResponse to a stream statusUpdate.
	// rpc AddFund (AddFundRequest) returns (AddFundResponse);
	AddFund(*AddFundRequest, Lightning_AddFundServer) error
	// * lncli： `extractfund`
	// ExtractFund attempts to extract some fund from an existring channel.
	ExtractFund(*ExtractFundRequest, Lightning_ExtractFundServer) error
	// *
	// SendPaymentSync is the synchronous non-streaming version of SendPayment.
	// This RPC is intended to be consumed by clients of the REST proxy.
	// Additionally, this RPC expects the destination's public key and the payment
...
func _Lightning_SendMultiPaymentsSync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendMultiRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightningServer).SendMultiPaymentsSync(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.Lightning/SendMultiPaymentsSync",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).SendMultiPaymentsSync(ctx, req.(*SendMultiRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Lightning_AddFund_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(AddFundRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(LightningServer).AddFund(m, &lightningAddFundServer{stream})
}

type Lightning_AddFundServer interface {
	Send(*OpenStatusUpdate) error
	grpc.ServerStream
}

type lightningAddFundServer struct {
	grpc.ServerStream
}

func (x *lightningAddFundServer) Send(m *OpenStatusUpdate) error {
	return x.ServerStream.SendMsg(m)
}

func _Lightning_ExtractFund_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ExtractFundRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(LightningServer).ExtractFund(m, &lightningExtractFundServer{stream})
}

type Lightning_ExtractFundServer interface {
	Send(*OpenStatusUpdate) error
	grpc.ServerStream
}

type lightningExtractFundServer struct {
	grpc.ServerStream
}

func (x *lightningExtractFundServer) Send(m *OpenStatusUpdate) error {
	return x.ServerStream.SendMsg(m)
}
...
var _Lightning_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SendMultiPaymentsSync",
			Handler:    _Lightning_SendMultiPaymentsSync_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "AddFund",
			Handler:       _Lightning_AddFund_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "ExtractFund",
			Handler:       _Lightning_ExtractFund_Handler,
			ServerStreams: true,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
